...
<div class="listDiv">
    <van-form @submit="onSubmit">
        ...
        <div>
            <van-cell-group>
                <van-field label="场名" :value="info.cowHouse || '根据牛耳号获取'" readonly />
                <van-field label="牛舍名" :value="info.cowHouse || '根据牛耳号获取'" readonly />
                <van-field label="发病日期" :value="info.callInAge || '根据牛耳号获取'" readonly />
                <van-field label="发病月龄" :value="info.birthTime || '根据牛耳号获取'" readonly />
                <van-field label="症状" :value="info.birthWeight || '根据牛耳号获取'" readonly />
                <van-field label="所属系统" :value="info.weight || '根据牛耳号获取'" readonly />
                <van-field label="症状备注" :value="info.weight || '根据牛耳号获取'" readonly />
            </van-cell-group>
        </div>
