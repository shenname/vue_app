  ...
  <div class="wrappers">
    ...
    <div v-if="onVif">  
        ...
        <van-form @submit="onSubmit">
            ...
            <van-field label="出售方"  name="sellFactoryName" required :rules="[{ required: true, message: '' }]" label-width="22%" colon v-model="formes.sellType"/>
            <van-field label="备注"  label-width="22%" colon v-model="formes.remark"/>
            </div>
